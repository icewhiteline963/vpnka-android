...
object SmartDeskSearch {
    ...
    data class Hit(
        ...
        val target: Target,
        /**
         * Что искать внутри приложения, когда оно откроется. Пока читается
         * не везде, но заполняется — поэтому поле остаётся: убрав его, я
         * молча поломал три вызова, передающих его позиционно.
         */
        val query: String = "",
