...
object SmartDeskSearch {
    ...
    data class Hit(
        ...
        val target: Target,
        /**
         * Строка запроса для будущего перехода «внутрь» приложения.
         *
         * Сейчас НЕ читается нигде: приложения открываются на своём обычном
         * экране. Поле оставлено сознательно — три вызова передают его
         * позиционно, и удаление ломает их молча.
         */
        val query: String = "",
